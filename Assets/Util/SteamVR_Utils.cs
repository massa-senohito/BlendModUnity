...
//
//=============================================================================
// https://github.com/gradientspace/gsUnityVR/tree/master/SteamVR/Scripts/SteamVR_Utils.cs の未使用部分を削除、改変したもの
...
public static class SteamVR_Utils
{
	...
	public static void GetTRS(this Matrix4x4 m , out Vector3 trans , out Quaternion rot , out Vector3 sca)
	{
		trans = m.GetPosition( );
		rot = m.GetRotation( );
		sca = m.GetScale( );
